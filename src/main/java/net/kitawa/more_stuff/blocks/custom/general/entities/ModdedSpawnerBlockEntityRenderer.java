...
public class ModdedSpawnerBlockEntityRenderer implements BlockEntityRenderer<ModdedSpawnerBlockEntity> {
    private final EntityRenderDispatcher entityRenderer;

    public ModdedSpawnerBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        this.entityRenderer = context.getEntityRenderer();
    }

    public void render(ModdedSpawnerBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    @Override
    public net.minecraft.world.phys.AABB getRenderBoundingBox(ModdedSpawnerBlockEntity blockEntity) {
