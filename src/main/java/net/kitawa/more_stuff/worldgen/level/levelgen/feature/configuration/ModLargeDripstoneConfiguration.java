...
public class ModLargeDripstoneConfiguration implements FeatureConfiguration {
    ...
    public final BlockStateProvider shellBlock;

    public ModLargeDripstoneConfiguration(
    ...
    public static final Codec<ModLargeDripstoneConfiguration> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    BlockStateProvider.CODEC.fieldOf("core_block").forGetter(cfg -> cfg.coreBlock),
                    BlockStateProvider.CODEC.fieldOf("shell_block").forGetter(cfg -> cfg.shellBlock)
            ).apply(instance, ModLargeDripstoneConfiguration::new)
    );
}
