package net.kitawa.more_stuff.worldgen.biome.surface;

import com.google.common.collect.ImmutableList;
import net.kitawa.more_stuff.blocks.ModBlocks;
import net.kitawa.more_stuff.worldgen.biome.ModBiomes;
import net.kitawa.more_stuff.worldgen.biome.surface.rules.NoiseThreshold3DConditionSource;
...
public class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource COPPER_NYLIUM = makeStateRule(ModBlocks.COPPER_NYLIUM.get());
    private static final SurfaceRules.RuleSource PYROLIZED_NETHERRACK = makeStateRule(ModBlocks.PYROLIZED_NETHERRACK.get());
    private static final SurfaceRules.RuleSource BLAZING_NYLIUM = makeStateRule(ModBlocks.BLAZING_NYLIUM.get());
    private static final SurfaceRules.RuleSource EBONY_WART_BLOCK = makeStateRule(ModBlocks.EBONY_WART_BLOCK.get());
    private static final SurfaceRules.RuleSource SOUL_SNOW = makeStateRule(ModBlocks.SOUL_SNOW_BLOCK.get());
    private static final SurfaceRules.RuleSource POWDER_SOUL_SNOW = makeStateRule(ModBlocks.POWDER_SOUL_SNOW.get());
    private static final SurfaceRules.RuleSource FROZEN_NETHERRACK = makeStateRule(ModBlocks.FROZEN_NETHERRACK.get());
    ...
    public static SurfaceRules.RuleSource overworldLike(boolean aboveGround, boolean bedrockRoof, boolean bedrockFloor) {
        ...
        SurfaceRules.ConditionSource surfacerules$conditionsource11 = SurfaceRules.isBiome(Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN, ModBiomes.FROZEN_AQUAPURANDA_FOREST);
        ...
        SurfaceRules.ConditionSource surfacerules$conditionsource13 = SurfaceRules.isBiome(Biomes.WARM_OCEAN, Biomes.BEACH, Biomes.SNOWY_BEACH, ModBiomes.WARM_AQUAPURANDA_FOREST);
        SurfaceRules.ConditionSource surfacerules$conditionsource14 = SurfaceRules.isBiome(Biomes.DESERT);
        SurfaceRules.RuleSource surfacerules$Amethyst = SurfaceRules.sequence(
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS, -0.0250, -0.0240), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS, -0.0200, -0.0190), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS, -0.0150, -0.0140), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS, -0.0100, -0.0090), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS, -0.0050, -0.0040), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS,  0.0040,  0.0050), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS,  0.0090,  0.0100), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS,  0.0140,  0.0150), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS,  0.0190,  0.0200), BUDDING_AMETHYST),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.PILLAR_RARENESS,  0.0240,  0.0250), BUDDING_AMETHYST),
                AMETHYST
        );
        SurfaceRules.RuleSource surfacerules$stoneVariants = SurfaceRules.sequence(
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.CALCITE, -0.0125, 0.0125), ANDESITE),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.GRAVEL, -0.0125, 0.0125), GRANITE),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.NOODLE, -0.15, -0.05), DIORITE),
                STONE
        );
        SurfaceRules.RuleSource surfacerules$CrystallineCaverns = SurfaceRules.sequence(
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.NETHER_STATE_SELECTOR, -0.075, 0.075), surfacerules$Amethyst),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.NETHER_STATE_SELECTOR, -0.2, 0.2), CALCITE),
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.NETHER_STATE_SELECTOR, -0.375, 0.375), SMOOTH_BASALT)
        );
        SurfaceRules.RuleSource surfacerules$DeepslateStoneVariants = SurfaceRules.sequence(
                SurfaceRules.ifTrue(new NoiseThreshold3DConditionSource(Noises.CALCITE, -0.0125, 0.0125), TUFF),
                DEEPSLATE
        );
        SurfaceRules.RuleSource surfacerules$CrystallineCavernsStone = SurfaceRules.sequence(
                surfacerules$CrystallineCaverns,
                surfacerules$stoneVariants
        );
        SurfaceRules.RuleSource surfacerules$DeepslateCrystallineCaverns = SurfaceRules.sequence(
                surfacerules$CrystallineCaverns,
                surfacerules$DeepslateStoneVariants
        );
        SurfaceRules.RuleSource surfacerules$rulesource3 = SurfaceRules.sequence(
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(Biomes.STONY_PEAKS),
                        SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.CALCITE, -0.0125, 0.0125), CALCITE), surfacerules$stoneVariants)
                ),
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(Biomes.STONY_SHORE),
                        SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.05, 0.05), surfacerules$rulesource2), surfacerules$stoneVariants)
                ),
                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_HILLS), SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), surfacerules$stoneVariants)),
                ...
                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.DRIPSTONE_CAVES), surfacerules$stoneVariants)
        );
        ...
        SurfaceRules.RuleSource surfacerules$rulesource6 = SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(
                        ...
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(surfacerules$conditionsource12, surfacerules$stoneVariants),
                                surfacerules$rulesource4,
                                SurfaceRules.ifTrue(surfacerules$conditionsource8, SNOW_BLOCK)
                        )
                ),
                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), surfacerules$stoneVariants),
                ...
                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WINDSWEPT_SAVANNA), SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), surfacerules$stoneVariants)),
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(Biomes.WINDSWEPT_GRAVELLY_HILLS),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(surfaceNoiseAbove(2.0), surfacerules$rulesource2),
                                SurfaceRules.ifTrue(surfaceNoiseAbove(1.0), surfacerules$stoneVariants),
        ...
        SurfaceRules.RuleSource surfacerules$rulesource7 = SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(
                        ...
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(surfacerules$conditionsource12, surfacerules$stoneVariants), SurfaceRules.ifTrue(surfacerules$conditionsource8, SNOW_BLOCK)
                        )
                ),
                SurfaceRules.ifTrue(
                ...
                SurfaceRules.ifTrue(
                        ...
                        SurfaceRules.sequence(SurfaceRules.ifTrue(surfaceNoiseAbove(1.75), surfacerules$stoneVariants), SurfaceRules.ifTrue(surfaceNoiseAbove(-0.5), COARSE_DIRT))
                ),
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(Biomes.WINDSWEPT_GRAVELLY_HILLS),
                        SurfaceRules.sequence(
        ...
        SurfaceRules.RuleSource surfacerules$rulesource8 = SurfaceRules.sequence(
                        ...
                        SurfaceRules.sequence(
                                ...
                                SurfaceRules.ifTrue(
                                        ...
                                        SurfaceRules.ifTrue(
                                                ...
                                                SurfaceRules.ifTrue(
                                                        SurfaceRules.not(surfacerules$conditionsource6), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0, Double.MAX_VALUE), WATER)
                                                )
                                        )
                                ),
                                SurfaceRules.ifTrue(
                ...
                SurfaceRules.ifTrue(
                        SurfaceRules.ON_FLOOR,
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.FROZEN_PEAKS, Biomes.JAGGED_PEAKS), surfacerules$stoneVariants),
                                SurfaceRules.ifTrue(SurfaceRules.isBiome(Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN, ModBiomes.WARM_AQUAPURANDA_FOREST, ModBiomes.LUKEWARM_AQUAPURANDA_FOREST), surfacerules$rulesource1),
                                surfacerules$rulesource2
                        )
                )
        );
        ...
        builder.add(SurfaceRules.ifTrue(SurfaceRules.verticalGradient("deepslate", VerticalAnchor.absolute(0), VerticalAnchor.absolute(8)),
                SurfaceRules.sequence(
                        SurfaceRules.ifTrue(
                                SurfaceRules.isBiome(ModBiomes.CRYSTALLINE_CAVERNS),
                                surfacerules$DeepslateCrystallineCaverns
                        ),
                        surfacerules$DeepslateStoneVariants
                )
        ));
        builder.add(
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.CRYSTALLINE_CAVERNS),
                        surfacerules$CrystallineCavernsStone
                ));
        builder.add(surfacerules$stoneVariants);
    ...
    public static SurfaceRules.RuleSource nether() {
        ...
        SurfaceRules.ConditionSource surfacerules$conditionsource6  = new NoiseThreshold3DConditionSource(Noises.SOUL_SAND_LAYER,       -0.012, Double.MAX_VALUE);
        SurfaceRules.ConditionSource surfacerules$conditionsource7  = new NoiseThreshold3DConditionSource(Noises.GRAVEL_LAYER,          -0.012, Double.MAX_VALUE);
        SurfaceRules.ConditionSource surfacerules$conditionsource8  = new NoiseThreshold3DConditionSource(Noises.PATCH,                 -0.012, Double.MAX_VALUE);
        SurfaceRules.ConditionSource surfacerules$conditionsource9  = new NoiseThreshold3DConditionSource(Noises.NETHERRACK,            0.54,   Double.MAX_VALUE);
        SurfaceRules.ConditionSource surfacerules$conditionsource10 = new NoiseThreshold3DConditionSource(Noises.NETHER_WART,           1.17,   Double.MAX_VALUE);
        SurfaceRules.ConditionSource surfacerules$conditionsource11 = new NoiseThreshold3DConditionSource(Noises.NETHER_STATE_SELECTOR, 0.0,    Double.MAX_VALUE);
        ...
        return SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.FROZEN_VALLEY),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        SurfaceRules.UNDER_CEILING, SurfaceRules.sequence(SurfaceRules.ifTrue(surfacerules$conditionsource11, POWDER_SOUL_SNOW), SOUL_SNOW)
                                ),
                                SurfaceRules.ifTrue(
                                        SurfaceRules.UNDER_FLOOR,
                                        SurfaceRules.sequence(surfacerules$rulesource, SurfaceRules.ifTrue(surfacerules$conditionsource11, POWDER_SOUL_SNOW), SOUL_SNOW)
                                )
                        )
                ),
                SurfaceRules.ifTrue(
                        ...
                        SurfaceRules.sequence(
                                ...
                                SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(ModBiomes.METALLIC_FOREST),
                                        SurfaceRules.ifTrue(
                                                SurfaceRules.not(surfacerules$conditionsource9),
                                                SurfaceRules.ifTrue(surfacerules$conditionsource, COPPER_NYLIUM)

                                        )
                                ),
                                SurfaceRules.ifTrue(
                                        SurfaceRules.isBiome(ModBiomes.PYROLIZED_FOREST, ModBiomes.BLAZING_FOREST),
                                        SurfaceRules.ifTrue(
                                                SurfaceRules.not(surfacerules$conditionsource9),
                                                SurfaceRules.ifTrue(
                                                        surfacerules$conditionsource,
                                                        SurfaceRules.sequence(SurfaceRules.ifTrue(surfacerules$conditionsource10, EBONY_WART_BLOCK), BLAZING_NYLIUM)
                                                )
                                        )
                                )
                        )
                ...
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.PYROLIZED_WASTES, ModBiomes.BLAZING_FOREST, ModBiomes.PYROLIZED_FOREST),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        SurfaceRules.UNDER_FLOOR,
                                        SurfaceRules.ifTrue(
    ...
    private static final SurfaceRules.RuleSource REVEALABLE_ENDSTONE = makeStateRule(ModBlocks.PHANTASMIC_ENDSTONE.get());
    private static final SurfaceRules.RuleSource PHANTASMIC_NYLIUM = makeStateRule(ModBlocks.PHANTASMIC_NYLIUM.get());
    private static final SurfaceRules.RuleSource HYBERNATIC_NYLIUM = makeStateRule(ModBlocks.HYBERNATIC_NYLIUM.get());
    private static final SurfaceRules.RuleSource ENDSTONE = makeStateRule(Blocks.END_STONE);

    public static SurfaceRules.RuleSource end() {
        return SurfaceRules.sequence(
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.PHANTASMIC_HIGHLANDS, ModBiomes.PHANTASMIC_MIDLANDS),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        SurfaceRules.ON_FLOOR,
                                        PHANTASMIC_NYLIUM
                ...
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.PHANTASMIC_BARRENS),
                        REVEALABLE_ENDSTONE
                ),
                SurfaceRules.ifTrue(
                        SurfaceRules.isBiome(ModBiomes.HYBERNATUS_HIGHLANDS, ModBiomes.HYBERNATUS_MIDLANDS),
                        SurfaceRules.sequence(
                                SurfaceRules.ifTrue(
                                        SurfaceRules.ON_FLOOR,
                                        HYBERNATIC_NYLIUM
