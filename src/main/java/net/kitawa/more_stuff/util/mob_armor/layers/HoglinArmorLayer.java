...
@OnlyIn(Dist.CLIENT)
public class HoglinArmorLayer extends RenderLayer<Hoglin, HoglinModel<Hoglin>> {
    private final HoglinModel<Hoglin> model;
    private static final Map<Crackiness.Level, ResourceLocation> ARMOR_CRACK_LOCATIONS = Map.of(
            Crackiness.Level.LOW,
            ResourceLocation.fromNamespaceAndPath(MoreStuff.MOD_ID, "textures/entity/hoglin/armor/cracks/hoglin_armor_crackiness_low.png"),
            Crackiness.Level.MEDIUM,
            ResourceLocation.fromNamespaceAndPath(MoreStuff.MOD_ID, "textures/entity/hoglin/armor/cracks/hoglin_armor_crackiness_medium.png"),
            Crackiness.Level.HIGH,
            ResourceLocation.fromNamespaceAndPath(MoreStuff.MOD_ID, "textures/entity/hoglin/armor/cracks/hoglin_armor_crackiness_high.png")
    );

    public HoglinArmorLayer(RenderLayerParent<Hoglin, HoglinModel<Hoglin>> renderer, EntityModelSet models) {
        super(renderer);
