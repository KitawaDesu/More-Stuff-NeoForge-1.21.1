...
public class PalladiumScaffoldingBlockItem extends BlockItem {
    public PalladiumScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return PalladiumScaffolding.getDistance(level, blockpos) == 9 ? null : context;
        } else {
            Direction direction;
