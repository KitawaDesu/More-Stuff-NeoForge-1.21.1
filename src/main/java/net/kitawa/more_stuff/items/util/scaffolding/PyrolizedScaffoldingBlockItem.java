...
public class PyrolizedScaffoldingBlockItem extends BlockItem {
    public PyrolizedScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return PyrolizedScaffolding.getDistance(level, blockpos) == 7 ? null : context;
        } else {
            Direction direction;
