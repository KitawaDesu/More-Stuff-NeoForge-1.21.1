...
public class CincinnasiteScaffoldingBlockItem extends BlockItem {
    public CincinnasiteScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return CincinnasiteScaffolding.getDistance(level, blockpos) == 12 ? null : context;
        } else {
            Direction direction;
