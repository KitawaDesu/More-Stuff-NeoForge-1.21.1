...
public class BronzeScaffoldingBlockItem extends BlockItem {
    public BronzeScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return BronzeScaffolding.getDistance(level, blockpos) == 12 ? null : context;
        } else {
            Direction direction;
