...
public class RosariteShearsItem extends Item {
    private final Tier tier;
    public RosariteShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), 21.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, 21.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, 21.0F - 1.0F),
