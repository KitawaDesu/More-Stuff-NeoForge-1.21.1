...
public class RoseGoldenShearsItem extends Item {
    private final Tier tier;
    public RoseGoldenShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), 18.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, 18.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, 18.0F - 1.0F),
