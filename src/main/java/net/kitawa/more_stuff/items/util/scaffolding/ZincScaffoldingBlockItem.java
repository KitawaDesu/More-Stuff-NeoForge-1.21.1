...
import net.kitawa.more_stuff.blocks.custom.nether.metallic_forest_blocks.scaffolding.IronScaffolding;
...
public class ZincScaffoldingBlockItem extends BlockItem {
    public ZincScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return ZincScaffolding.getDistance(level, blockpos) == 13 ? null : context;
        } else {
            Direction direction;
