...
public class CopperScaffoldingBlockItem extends BlockItem {
    public CopperScaffoldingBlockItem(Block block, Item.Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return CopperScaffolding.getDistance(level, blockpos) == 10 ? null : context;
        } else {
            Direction direction;
