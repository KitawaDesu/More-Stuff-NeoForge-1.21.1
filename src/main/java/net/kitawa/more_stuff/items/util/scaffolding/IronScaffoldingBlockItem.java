...
public class IronScaffoldingBlockItem extends BlockItem {
    public IronScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return IronScaffolding.getDistance(level, blockpos) == 13 ? null : context;
        } else {
            Direction direction;
