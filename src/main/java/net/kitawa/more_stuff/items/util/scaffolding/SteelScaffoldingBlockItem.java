...
public class SteelScaffoldingBlockItem extends BlockItem {
    public SteelScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return SteelScaffolding.getDistance(level, blockpos) == 15 ? null : context;
        } else {
            Direction direction;
