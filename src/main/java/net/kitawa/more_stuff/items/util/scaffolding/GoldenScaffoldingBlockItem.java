...
import net.kitawa.more_stuff.blocks.custom.nether.metallic_forest_blocks.scaffolding.GoldenScaffolding;
...
public class GoldenScaffoldingBlockItem extends BlockItem {
    public GoldenScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return GoldenScaffolding.getDistance(level, blockpos) == 16 ? null : context;
        } else {
            Direction direction;
