...
public class NetheriteShearsItem extends Item {
    private final Tier tier;
    public NetheriteShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), Tiers.NETHERITE.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, Tiers.NETHERITE.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, Tiers.NETHERITE.getSpeed() - 1.0F),
