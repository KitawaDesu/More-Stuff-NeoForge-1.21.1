...
public class DiamondShearsItem extends Item {
    ...
    public DiamondShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), Tiers.DIAMOND.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, Tiers.DIAMOND.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, Tiers.DIAMOND.getSpeed() - 1.0F),
