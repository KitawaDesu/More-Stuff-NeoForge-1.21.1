...
public class GoldenShearsItem extends Item {
    private final Tier tier;
    public GoldenShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), Tiers.GOLD.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, Tiers.GOLD.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, Tiers.GOLD.getSpeed() - 1.0F),
