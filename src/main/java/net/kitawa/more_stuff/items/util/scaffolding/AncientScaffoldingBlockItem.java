...
import net.kitawa.more_stuff.blocks.custom.nether.metallic_forest_blocks.scaffolding.AncientScaffolding;
...
public class AncientScaffoldingBlockItem extends BlockItem {
    public AncientScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return AncientScaffolding.getDistance(level, blockpos) == 19 ? null : context;
        } else {
            Direction direction;
