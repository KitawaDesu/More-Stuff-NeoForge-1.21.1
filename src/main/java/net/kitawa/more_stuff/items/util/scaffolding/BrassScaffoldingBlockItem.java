...
public class BrassScaffoldingBlockItem extends BlockItem {
    public BrassScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return BrassScaffolding.getDistance(level, blockpos) == 12 ? null : context;
        } else {
            Direction direction;
