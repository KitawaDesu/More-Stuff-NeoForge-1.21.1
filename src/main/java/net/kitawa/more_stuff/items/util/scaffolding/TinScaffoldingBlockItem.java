...
public class TinScaffoldingBlockItem extends BlockItem {
    public TinScaffoldingBlockItem(Block block, Properties properties) {
    ...
    public BlockPlaceContext updatePlacementContext(BlockPlaceContext context) {
        ...
        if (!blockstate.is(block)) {
            return TinScaffolding.getDistance(level, blockpos) == 13 ? null : context;
        } else {
            Direction direction;
