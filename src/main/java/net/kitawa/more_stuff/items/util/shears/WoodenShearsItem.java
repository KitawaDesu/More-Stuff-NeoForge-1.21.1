...
public class WoodenShearsItem extends Item {
    ...
    public WoodenShearsItem(Tier tier, Item.Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), Tiers.WOOD.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, Tiers.WOOD.getSpeed() + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, Tiers.WOOD.getSpeed() - 1.0F),
