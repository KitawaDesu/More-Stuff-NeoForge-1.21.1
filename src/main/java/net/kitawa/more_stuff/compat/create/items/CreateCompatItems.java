...
public class CreateCompatItems {
    ...
    public static final DeferredItem<Item> BRASS_HELMET = ITEMS.register("brass_helmet",
            () -> new ArmorItem(CreateCompatArmorMaterials.BRASS, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(26))));
    public static final DeferredItem<Item> BRASS_CHESTPLATE = ITEMS.register("brass_chestplate",
            () -> new ArmorItem(CreateCompatArmorMaterials.BRASS, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(26))));
    public static final DeferredItem<Item> BRASS_LEGGINGS = ITEMS.register("brass_leggings",
            () -> new ArmorItem(CreateCompatArmorMaterials.BRASS, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(26))));
    public static final DeferredItem<Item> BRASS_BOOTS = ITEMS.register("brass_boots",
            () -> new ArmorItem(CreateCompatArmorMaterials.BRASS, ArmorItem.Type.BOOTS, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(26))));

    public static final DeferredItem<Item> BRASS_PICKAXE = ITEMS.register("brass_pickaxe",
            () -> new PickaxeItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(PickaxeItem.createAttributes(Tiers.IRON, 1.0F, -2.8F))));
    public static final DeferredItem<Item> BRASS_HOE = ITEMS.register("brass_hoe",
            () -> new HoeItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(HoeItem.createAttributes(Tiers.IRON, -4.0F, 0.0F))));
    public static final DeferredItem<Item> BRASS_SWORD = ITEMS.register("brass_sword",
            () -> new SwordItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(SwordItem.createAttributes(Tiers.IRON, 3, -2.4F))));
    public static final DeferredItem<Item> BRASS_SHOVEL = ITEMS.register("brass_shovel",
            () -> new ShovelItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(ShovelItem.createAttributes(Tiers.IRON, 1.5F, -3.0F))));
    public static final DeferredItem<Item> BRASS_AXE = ITEMS.register("brass_axe",
            () -> new AxeItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(AxeItem.createAttributes(Tiers.IRON, 5.0F, -3.0F))));
    ...
    public static final DeferredItem<Item> BRASS_WOLF_ARMOR = ITEMS.register("brass_wolf_armor",
            () -> new CreateCompatAnimalArmorItem(CreateCompatArmorMaterials.BRASS, CreateCompatAnimalArmorItem.BodyType.BRASS_CANINE, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(26))));

    public static final DeferredItem<Item> BRASS_HOGLIN_ARMOR = ITEMS.register("brass_hoglin_armor",
            () -> new CreateCompatAnimalArmorItem(CreateCompatArmorMaterials.BRASS, CreateCompatAnimalArmorItem.BodyType.BRASS_HOG, true, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(26))));

    public static final DeferredItem<Item> BRASS_HORSE_ARMOR = ITEMS.register("brass_horse_armor",
            () -> new AnimalArmorItem(CreateCompatArmorMaterials.BRASS, AnimalArmorItem.BodyType.EQUESTRIAN, false, new Item.Properties().durability(ArmorItem.Type.BODY.getDurability(26))));

    public static final DeferredItem<Item> BRASS_MACE = ITEMS.register("brass_mace",
            () -> new ModdedMaceItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().attributes(SwordItem.createAttributes(Tiers.IRON, 3 * 0.8333333333F, -3.4F))));
    ...
    public static final DeferredItem<Item> BRASS_SHEARS = ITEMS.register("brass_shears",
            () -> new BrassShearsItem(new SimpleTier(ModBlockTags.INCORRECT_FOR_BRASS_TOOL, 375, 9.0F, 2.0F, 14, () -> Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath("create", "brass_ingot")))), new Item.Properties().durability((int) (375 * 0.952)).component(DataComponents.TOOL, BrassShearsItem.createToolProperties())));
