package net.kitawa.more_stuff.compat.create.items.util.shears;
...
public class BrassShearsItem extends Item {
    private final Tier tier;
    public BrassShearsItem(Tier tier, Properties properties) {
        super(properties);
        this.tier = tier;
    }
    ...
    public static Tool createToolProperties() {
        return new Tool(
                List.of(
                        Tool.Rule.minesAndDrops(List.of(Blocks.COBWEB), 9.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.LEAVES, 9.0F + 9.0F),
                        Tool.Rule.overrideSpeed(BlockTags.WOOL, 9.0F - 1.0F),
